...
export function animate(
  ...
  return new Promise((resolve) => {
    ...
    if (duration) (node as HTMLElement).style.setProperty('--animate-duration', duration);
    if (delay) (node as HTMLElement).style.setProperty('--animate-delay', delay);
    if (repeat) (node as HTMLElement).style.setProperty('--animate-repeat', repeat.toString());
